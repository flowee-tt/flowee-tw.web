/* ==========================================
   WEB LỚP A6 - COMMERCIAL MULTI-CLASS ENGINE (DUAL GATEWAY EDITION)
   Features:
   1. Super Admin Dual Access: Enter PIN 999999 in Auth Gateway on index.html OR visit admin.html.
      Opens Full Commercial Multi-Class System Dashboard with ZERO 404 errors!
   2. Real-time Multi-User Heart Like Sync Engine.
   3. Restored Class Admin Student Password Controls.
   4. Premium IG/FB Style Auth Gateway.
   ========================================== */
